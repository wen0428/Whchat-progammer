...
export default class Swipver extends Component {
  render() {
    return ( 
      <View className='at-row swipver'>
        <View className='at-col'>
          <Swiper className='test-h' indicatorColor='#999' indicatorActiveColor='#333' vertical  indicatorDots autoplay>
          {
            data.map(item => (
