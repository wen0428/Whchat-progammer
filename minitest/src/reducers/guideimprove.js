import { GUIDEIMPROVE } from '../constants/counter'
...
export default function guideimprove (state = INITIAL_STATE, action) {
  switch (action.type) {
    case GUIDEIMPROVE:
      return {
        ...state,
